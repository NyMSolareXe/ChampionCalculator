...
// Create the table using javascript
let myLevel = 1;
...
// Checks if you clicked on the DIV or the H6 element of the Champion Hint
...
// Searches array of championlist vs Searchbox
const searchChampions = async searchText => {
  ...
  if (found) {
    ...
    changeChampionSkin(found);
    calculateValues();
  }
};


// Takes the champion object and populates the input fields
